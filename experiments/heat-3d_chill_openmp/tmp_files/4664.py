...
destination('/uufs/chpc.utah.edu/common/home/u1142914/lib/ytopt_vinu/experiments/heat-3d_chill_openmp/tmp_files/4664.c')
procedure('kernel_heat_3d')
loop(0)
known('n>3')

pragma(0,2,"omp parallel for private(t4,t6,t8,t10)")
tile(0,2,8,2)
tile(0,4,8,4)
