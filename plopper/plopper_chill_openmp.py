...
class Plopper:
        ...
        with open(outputfile, "w") as f2:
            for line in buf:
                ...
                if 'SRC' in modify_line:
                    modify_line = modify_line.replace('SRC',inputfile[:-len('chill_openmp.py')] + 'kernel.c')
    ...
    def findRuntime(self, x, params):
        ...
        cmd1 = "clang " + kernel_dir  + "/rest.c "  +interimfile[:-2] + 'c'+" /uufs/chpc.utah.edu/common/home/u1142914/lib/ytopt_vinu/polybench/polybench-code/utilities/polybench.c -O3 -DPOLYBENCH_TIME -fopenmp -lm -L${HOME}/lib/openmp-build/runtime/src -I${HOME}/lib/openmp-build/runtime/src -o "+tmpbinary
